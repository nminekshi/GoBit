...
const items = [
  { name: "Tesla Model S", img: "/images/Tesla Model S.png", currentBid: 55000, endsIn: "6h 20m" },
  { name: "BMW X5", img: "/images/BMW X5 .png", currentBid: 42000, endsIn: "5h 10m" },
  { name: "Audi Q7", img: "/images/Audi Q7.png", currentBid: 39000, endsIn: "7h 30m" },
  { name: "Mercedes-Benz C-Class", img: "/images/Mercedes-Benz C-Class.png", currentBid: 37000, endsIn: "8h 15m" },
  { name: "Toyota Land Cruiser", img: "/images/Toyota Land Cruiser.png", currentBid: 32000, endsIn: "9h 5m" },
  { name: "Ford Mustang", img: "/images/Ford Mustang.png", currentBid: 28000, endsIn: "10h 40m" },
];
    ...
    <div className="min-h-screen bg-white flex flex-col items-center py-12">
      <div className="w-full max-w-7xl flex gap-8">
        <div className="hidden md:block w-72 shrink-0">
          <CategorySidebar category="vehicles" />
        </div>
        <div className="flex-1">
          <h1 className="text-5xl font-bold text-gray-700 mb-10">Vehicles Auction</h1>
